 ...
 * @LastEditTime: 2023-01-13 11:51:34
...
export function getPurchaseStockAllData(query) {
  return request({
    url: '/order/get_purchase_stock_all_data',
    method: 'get',
    params: query
  })
}
...
export function getOutboundStockAllData(query) {
  return request({
    url: '/order/get_outbound_stock_all_data',
    method: 'get',
    params: query
  })
}
...
export function getPurchaseStockDataList(query) {
  return request({
    url: '/order/get_purchase_stock_data_list',
    method: 'get',
    params: query
  })
}
...
export function getOutboundStockDataList(query) {
  return request({
    url: '/order/get_outbound_stock_data_list',
    method: 'get',
    params: query
  })
}
