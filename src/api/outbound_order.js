 ...
 * @LastEditTime: 2023-01-14 12:59:56
...
export function getOutboundBarStatistics(query) {
  return request({
    url: '/order/get_outbound_bar_statistics',
    method: 'get',
    params: query
  })
}
...
export function getOutboundPieStatistics(query) {
  return request({
    url: '/order/get_outbound_pie_statistics',
    method: 'get',
    params: query
  })
}
...
export function getOutboundPriceStatistics(query) {
  return request({
    url: '/order/get_outbound_price_statistics',
    method: 'get',
    params: query
  })
}
...
export function getOutboundPieceStatistics(query) {
  return request({
    url: '/order/get_outbound_piece_statistics',
    method: 'get',
    params: query
  })
}
...
export function getTotalOutboundPriceAndPiece(query) {
  return request({
    url: '/order/get_total_outbound_price_and_piece',
    method: 'get',
    params: query
  })
}
...
export function getOutboundProductDetails(query) {
  return request({
    url: '/order/get_outbound_product_details',
    method: 'get',
    params: query
  })
}
